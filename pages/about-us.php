...
$head = [
    ...
    "scripts" => ["{$PATH}js/zoom.js", "{$PATH}js/slideshow.js", "{$PATH}js/readmore.js"]
];
...
<main class="main-for-aboutus main-margin   ">
    ...
    <section class="class-for-aboutus-1">
        ...
        <article>
            ...
            <p class="readmore">Quality is at the heart of everything we do. From the moment our seafood is caught to the final presentation on your plate, we uphold the highest standards of freshness, flavor, and integrity. Our chefs meticulously select the finest ingredients, hand-crafting each dish with precision and passion to deliver an unparalleled dining experience that exceeds expectations.</p>
        </article>
    </section>
    ...
    <section class="class-for-aboutus-2">
        <article>
            ...
            <p class="readmore">We believe that good food should nourish both body and soul, which is why we prioritize health and sustainability in every aspect of our operation. Our menu features a diverse array of nutritious and wholesome seafood options, prepared with care to preserve their natural goodness. Additionally, we are dedicated to minimizing our environmental footprint, implementing eco-friendly practices such as waste reduction, energy conservation, and plastic-free packaging.</p>
        </article>
    ...
    <section class="class-for-aboutus-2">
        <article>
            ...
            <p class="readmore">Ready to experience the magic of our fish restaurant for yourself? Book your table today and embark on a culinary adventure that celebrates the best of the ocean's bounty. We look forward to welcoming you and creating unforgettable memories together!</p>
        </article>
