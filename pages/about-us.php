...
<main class="main-for-aboutus">
    ...
    <section class="class-for-aboutus-2">
        <article>
            ...
            <p>At our restaurant, sustainability isn't just a buzzword—it's a way of life. We are committed to sourcing our seafood responsibly, partnering with local fishermen and trusted suppliers who share our dedication to preserving marine ecosystems for future generations. By prioritizing sustainable practices, we ensure that every ingredient on our menu is not only delicious but also environmentally conscious.</p>
        </article>
        <img src="../assets/fish-sustaina.jfif" alt="">
    </section>

    <section class="class-for-aboutus-1">
        <img src="../assets/quality.jfif " alt="">
        <article>
            <h3>Uncompromising Quality</h3>
            <p>Quality is at the heart of everything we do. From the moment our seafood is caught to the final presentation on your plate, we uphold the highest standards of freshness, flavor, and integrity. Our chefs meticulously select the finest ingredients, hand-crafting each dish with precision and passion to deliver an unparalleled dining experience that exceeds expectations.</p>
        </article>
    </section>
    ...
    <section class="class-for-aboutus-2">
        <article>
            ...
            <p>We believe that good food should nourish both body and soul, which is why we prioritize health and sustainability in every aspect of our operation. Our menu features a diverse array of nutritious and wholesome seafood options, prepared with care to preserve their natural goodness. Additionally, we are dedicated to minimizing our environmental footprint, implementing eco-friendly practices such as waste reduction, energy conservation, and plastic-free packaging.</p>
        </article>
        <img src="../assets/health and sust.webp" alt="">
    </section>

    <section class="class-for-aboutus-1">
        <img src="../assets/support.jfif " alt="">
        <article>
            <h3>Supporting Our Community</h3>
            <p>As a locally owned and operated establishment, we are deeply rooted in our community and are proud to give back in meaningful ways. We partner with local organizations and charities to support initiatives that promote ocean conservation, marine education, and sustainable fishing practices. By fostering strong ties with our community, we strive to make a positive impact that extends far beyond our restaurant walls.</p>
        </article>
    </section>
    ...
    <section class="class-for-aboutus-2">
        <article>
            ...
            <p>Ready to experience the magic of our fish restaurant for yourself? Book your table today and embark on a culinary adventure that celebrates the best of the ocean's bounty. We look forward to welcoming you and creating unforgettable memories together!</p>
        </article>
        <img src="../assets/join us.webp" alt="">
    </section>
